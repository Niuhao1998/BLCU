<%@ Page Language="C#" AutoEventWireup="true" CodeFile="reservation.aspx.cs" Inherits="Admin_reservation" %>
...
<div id="page">
  <div id="header">
    ...
    <div id="menu">
            <ul>
                <li class="current_page_item"><a href="#" accesskey="1" title="">预约教室</a></li>
                <li><a href="../Admin/Cancel.aspx" accesskey="2" title="">取消预约</a></li>
                <li><a href="../Admin/classroom.aspx" accesskey="3" title="">可借教室</a></li>
                ...
                <ContentTemplate>
                    <asp:GridView style="float:left" CssClass="table table-striped table-bordered" ID="GridView1" runat="server" AllowPaging="True" AutoGenerateColumns="False" Width="1055px" CaptionAlign="Bottom" ClientIDMode="Static" ShowHeader="False" BorderColor="#555555" BorderStyle="Solid"  OnPageIndexChanging="GridView1_PageIndexChanging" PageSize="5">
                        ...
                        <Columns>
                            ...
                            <ItemStyle BorderStyle="Solid" HorizontalAlign="Center" Width="175px" Wrap="False" />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="教学楼" DataField="building" >
                            <HeaderStyle HorizontalAlign="Center" Width="175px" />
                            <ItemStyle HorizontalAlign="Center" Width="175px" Wrap="False" />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="教室" DataField="room" >
                            
                            <HeaderStyle HorizontalAlign="Center" BorderStyle="Solid" Width="175px" Wrap="False" />
                            <ItemStyle HorizontalAlign="Center" Width="175px" Wrap="False" />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="类型" DataField="type" >
                            
                            <HeaderStyle HorizontalAlign="Center" Width="175px" Wrap="False" />
                            <ItemStyle HorizontalAlign="Center" Width="175px" Wrap="False" />
                            </asp:BoundField>
                            ...
                            <asp:TemplateField ShowHeader="False" HeaderText="预约">
                            
                                <HeaderStyle Width="175px" Wrap="False" />
                            <ItemStyle VerticalAlign="Middle" Width="175px" Wrap="False" />
                                <ItemTemplate>
                                    <a href="javascript:void(0)" onclick="showFloat(<%# Eval("room") %>)" class="reservation" >预约</a>
                                    <%--<asp:LinkButton ID="OpenReservation" runat="server"  OnClick="btnGvDelete_OnClick" CommandArgument='<%# Eval("room") %>' CommandName="getRoom">预约</asp:LinkButton>--%>
                                </ItemTemplate>
                            </asp:TemplateField>
