...
public partial class Users_Cancel : System.Web.UI.Page, IHttpHandler, IRequiresSessionState
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            sql1 += " from BorrowLog where userID = '" + userid + "' and IsDeleted=0 order by date desc";
